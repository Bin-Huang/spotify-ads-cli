...
Spotify Ads CLI & Skills for AI agents (and humans). Pull aggregate and demographic insight reports, estimate audience and bid ranges, manage audio creatives, track measurement pixels, and more.
...
npx skills add Bin-Huang/spotify-ads-cli
```
